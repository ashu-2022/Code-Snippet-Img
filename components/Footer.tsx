  ...
  return (
    <div className="flex items-center gap-10 py-16">
      <Link
        ...
        href="https://www.youtube.com/channel/UCXEABugndLj6VXfZSF8Q0Ag"
      >
        Subscribe Here &nbsp;&#129109;
      </Link>
      <Link
        href="https://ashutosh-pandit.netlify.app/"
      ...
      >
        ...
        <span className="pl-1 font-medium text-slate-200">Ashutosh Pandit</span>
      </Link>
      <Link
        href="https://github.com/ashu-2022"
        className="flex items-center text-sm font-medium hover:text-slate-200 ease-in-out transition-all duration-500"
      >
        Source Code Here &nbsp;&#129109;
      </Link>
